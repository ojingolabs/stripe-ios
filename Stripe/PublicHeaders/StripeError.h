...
#define STPCardErrorInvalidNumberUserMessage NSLocalizedStringFromTableInBundle(@"Your card's number is invalid.", @"Stripe-Localizable", [Stripe getStripeBundle], @"Error when the card number is not valid")
#define STPCardErrorInvalidCVCUserMessage NSLocalizedStringFromTableInBundle(@"Your card's security code is invalid.", @"Stripe-Localizable", [Stripe getStripeBundle], @"Error when the card's CVC is not valid")
#define STPCardErrorInvalidExpMonthUserMessage                                                                                                                 \
    NSLocalizedStringFromTableInBundle(@"Your card's expiration month is invalid.", @"Stripe-Localizable", [Stripe getStripeBundle], @"Error when the card's expiration month is not valid")
#define STPCardErrorInvalidExpYearUserMessage                                                                                                                  \
    NSLocalizedStringFromTableInBundle(@"Your card's expiration year is invalid.", @"Stripe-Localizable", [Stripe getStripeBundle], @"Error when the card's expiration year is not valid")
#define STPCardErrorExpiredCardUserMessage NSLocalizedStringFromTableInBundle(@"Your card has expired.", @"Stripe-Localizable", [Stripe getStripeBundle], @"Error when the card has already expired")
#define STPCardErrorDeclinedUserMessage NSLocalizedStringFromTableInBundle(@"Your card was declined.", @"Stripe-Localizable", [Stripe getStripeBundle], @"Error when the card was declined by the credit card networks")
#define STPUnexpectedError                                                                                                                                     \
    NSLocalizedStringFromTableInBundle(@"There was an unexpected error -- try again in a few seconds", @"Stripe-Localizable", [Stripe getStripeBundle], @"Unexpected error, such as a 500 from Stripe or a JSON parse error")
#define STPCardErrorProcessingErrorUserMessage                                                                                                                 \
    NSLocalizedStringFromTableInBundle(@"There was an error processing your card -- try again in a few seconds", @"Stripe-Localizable", [Stripe getStripeBundle], @"Error when there is a problem processing the credit card")
